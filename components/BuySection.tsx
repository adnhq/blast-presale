...
export default function BuySection() {
  ...
  return (
    <div className="h-full relative group">
      ...
      <div className="relative h-full bg-gradient-to-b from-black/95 to-black/90 backdrop-blur-xl">
        {/* Top accent line */}
          ...
          <div className="text-center mb-6 md:mb-8">
            <div className="relative inline-block">
              <div className="flex items-center justify-center gap-2 mb-4 relative">
                ...
                <h2 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-blue-400 to-cyan-500 text-transparent bg-clip-text animate-gradient">
                  BLAST Presale
                </h2>
            ...
            <CountdownTimer />
            <div className="mt-4 md:mt-6 text-lg md:text-xl font-semibold flex items-center justify-center gap-2">
          ...
          <div className="space-y-4 md:space-y-6 flex-1">
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              {["SOL", "BNB"].map((currency) => (
                <Button
                  ...
                  className={`h-12 md:h-16 relative overflow-hidden transition-all duration-300 ${
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-12 md:h-14 text-base md:text-lg bg-white/5 border-white/10 focus:border-blue-400 transition-colors duration-300"
                placeholder="0.0"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-12 md:h-14 text-base md:text-lg bg-white/5 border-white/10"
                placeholder="0.0"
              />
            </div>

            <Button
              className="w-full h-12 md:h-14 text-base md:text-lg font-bold relative overflow-hidden group"
            ...
            >
              ...
              <div className="relative flex items-center justify-center gap-2">
                <Wallet className={`w-5 h-5 md:w-6 md:h-6 transition-transform duration-300 ${isHovered ? 'scale-110' : 'scale-100'}`} />
